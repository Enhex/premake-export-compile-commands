...
```
git clone https://github.com/tarruda/premake-export-compile-commands compile-commands
```
...
After the above steps, the "compile-commands" action will be available
for your projects:

```
premake5 compile-commands
```
